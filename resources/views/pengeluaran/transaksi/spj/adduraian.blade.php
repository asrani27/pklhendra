   ...
   <div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/staf/transaksi/spj/adduraian/{{$id}}" method="post">
                @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href="/staf/transaksi/spj/detail/{{$id}}" class="btn bg-gray btn-flat btn-block"><i class="fa fa-arrow-left"></i> Kembali</a>
                  </div>
                </div>
              </div>
            </form>
