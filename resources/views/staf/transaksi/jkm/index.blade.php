        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-clipboard"></i> Data JKM</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size:10px; background-color:silver">
                  ...
                  <th>Nama / Jabatan</th>
                  <th>Jumlah Iuran JKM yang dibayar bulan </th>
                  <th>Aksi</th>
                </tr>
                ...
                <tr>
                    ...
                    <td>{{number_format($item->iuran_jkm)}}</td>
                    <td>
                      <a href="#" data-id="{{$item->id}}" data-iuran="{{$item->iuran_jkm}}" class="btn btn-xs btn-flat edit-iuran btn-success"><i class="fa fa-edit"></i> isi</a>
                    </td>
                </tr>
                @endforeach
...
<div class="modal fade" id="modal-edit">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="/staf/transaksi/detail/{{$id}}/jkm">
      <div class="modal-body">
          @csrf
          
          <div class="form-group">
              <label>Iuran JKM</label>
              <input type="text" id="iuran" class="form-control" name="iuran" onkeypress="return hanyaAngka(event)">
              <input type="hidden" id="jkm_id" class="form-control" name="jkk_id">
          </div>
      </div>
