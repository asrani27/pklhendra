   ...
   <div class="row">
    <div class="col-md-12">
        <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="/staf/transaksi/detail/{{$id}}/jkn/edit/{{$data->id}}" method="post">
                @csrf
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="honor" value="{{$data->honor}}" required onkeypress="return hanyaAngka(event)">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Standar Potongan Iuran JKN KIS (UMP/UMK)</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="umr" value="{{$data->umr}}" required onkeypress="return hanyaAngka(event)">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Potongan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="potongan" value="{{$data->potongan}}" required onkeypress="return hanyaAngka(event)">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Jumlah Bulan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="jumlah" value="{{$data->jumlah}}" value="1" required onkeypress="return hanyaAngka(event)">
                  </div>
                </div>
                <div class="form-group">
