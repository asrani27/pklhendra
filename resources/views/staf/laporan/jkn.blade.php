        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title"><i class="fa fa-clipboard"></i> Laporan JKN</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size:10px;">
                    ...
                    <td>
                        <a href="/staf/laporan/jkn/cetak/{{$item->id}}"  class="btn btn-sm btn-flat btn-danger" target="_blank"><i class="fa fa-print"></i> PRINT</a>
                    </td>
                </tr>
                @endforeach
