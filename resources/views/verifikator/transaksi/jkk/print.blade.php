...
<body>
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td colspan=7 style="font-family: Arial, Helvetica, sans-serif;font-size:10px;font-weight:bold; text-align:center">
              DAFTAR NOMINATIF PEMBAYARAN IURAN JAMINAN KECELAKAAN KERJA NON ASN
                <br/>
    ...
    <table width="100%" border=1 cellpadding="3" cellspacing="0">
      <tr style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size:10px;">
        ...
        <th class="text-center" style="vertical-align: middle">Jumlah Iuran JKK yang dibayar</th>
      ...
      <tr style="font-family: 'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size:10px;">
        <td></td>
        <td>JUMLAH</td>
        <td style="text-align: center">{{number_format($data->sum('iuran_jkk'))}}</td>
        <td></td>
      </tr>
    </table>
    <table width="100%">
