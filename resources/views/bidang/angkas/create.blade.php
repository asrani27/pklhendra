        ...
        <div class="col-md-9">
            <div class="box box-primary">
                <div class="box-header with-border">
                  ...
                  <div class="box-tools">
                    <a href="/bidang/program/kegiatan/{{$program->id}}/sub/{{$kegiatan->id}}/uraian/{{$subkegiatan->id}}/" class="btn btn-sm bg-gray btn-flat"><i class="fa fa-arrow-left"></i> Kembali</a>
                  </div>
                </div>
                <!-- /.box-header -->
                <form class="form-horizontal" method="POST" action="/bidang/program/angkas/{{$program->id}}/{{$kegiatan->id}}/{{$subkegiatan->id}}/{{$uraian->id}}">
                  @csrf
                  <div class="box-body">
