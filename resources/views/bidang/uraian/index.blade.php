        ...
        <div class="col-md-9">
            <div class="box box-primary">
                <div class="box-header">
                  ...
                  <div class="box-tools">
                    <a href="/bidang/program/kegiatan/{{$program->id}}/sub/{{$kegiatan->id}}/" class="btn btn-sm bg-gray btn-flat"><i class="fa fa-arrow-left"></i> Kembali</a>
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/bidang/program/angkas/{{$program_id}}/{{$kegiatan_id}}/{{$subkegiatan_id}}/{{$item->id}}"
